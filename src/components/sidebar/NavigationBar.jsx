...
function NavigationBar() {
  ...
  const { sidebar, tab, setState, center } = useContext(AppContext);
  ...
  return (
    <ButtonGroup className={`backdrop-blur navigation-bar${sidebar ? ' navigation-bar-opened' : ''}`} component={Paper} elevation={5} sx={{ background: theme.palette.primary.main }} orientation="vertical">
      ...
      <IconButton onClick={() => {
       ...
       <IconButton component={'a'} href={`https://livingatlas.arcgis.com/wayback/#active=27982&mapCenter=${center[0]},${center[1]}`} target="_blank" sx={{
        '&:hover': {
          background: theme.palette.selected.main + '99'
        },
        borderRadius: 0
